...
class depth_anything_v2(nn.Module):
    """Depth Anything V2"""
    ...
    def __init__(
        ...
        assert num_classes == 1, "Depth Anything V2 only supports 1 output channel"
        ...
        self.model = DepthAnythingV2(**model_configs[backbone])
        ...
        if lora_rank > 0:
            self.model = apply_lora(self.model, rank=lora_rank)
